...
import com.valdroide.thesportsbillboardinstitution.main_user.navigation.with_menu.*
...
@Module
class NavigationActivityMenuModule(val context: Context, var view: NavigationActivityView) {
