...
class TournamentActivityAdapter(private var subMenus: MutableList<SubMenuDrawer>?,
    ...
    init {
        activityTounament = activity as TournamentActivity
    }
    ...
    class ViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView) {
        ...
        private fun setOnItemClickListener(listener: GenericOnItemClickListener.actualUnActual, position: Int,
                                   subMenus: SubMenuDrawer, tournament: Tournament?, activity: TournamentActivity) {
            itemView.checkBoxTournament.setOnClickListener { view ->
