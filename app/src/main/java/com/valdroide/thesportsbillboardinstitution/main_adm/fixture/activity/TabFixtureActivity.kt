...
open class TabFixtureActivity : AppCompatActivity(), Communicator {
...
//     ADEFUL
    private fun setPagerAdapter() {
        ...
        val fragments = arrayOf(FixtureCreateFragment(), FixtureUpdateFragment())
        adapter = SectionsPagerAdapter(supportFragmentManager, titles, fragments)
    }
    ...
    override fun refreshAdapter() {
        getFixtureUpdateFragment().refreshAdapter()
    }

    fun getFixtureUpdateFragment(): FixtureUpdateFragment {
        val manager = supportFragmentManager
        return manager
                .findFragmentByTag("android:switcher:" + viewPager.id
                        + ":" + 1) as FixtureUpdateFragment
    }
}