...
open class TabSanctionActivity : AppCompatActivity(), Communicator {
...
//     ADEFUL
    private fun setPagerAdapter() {
        ...
        val fragments = arrayOf(SanctionCreateFragment(), SanctionUpdateFragment())
        adapter = SectionsPagerAdapter(supportFragmentManager, titles, fragments)
    }
    ...
    fun getNewsUpdateFragment(): SanctionUpdateFragment {
        val manager = supportFragmentManager
        return manager
                .findFragmentByTag("android:switcher:" + viewPager.id
                        + ":" + 1) as SanctionUpdateFragment
    }
}